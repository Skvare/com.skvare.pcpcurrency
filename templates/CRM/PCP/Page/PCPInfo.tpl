     ...
     {if $pcp.is_thermometer OR $pcp.is_honor_roll}
      ...
      <div class="thermometer-wrapper">
          <div class="pcp-amount-goal">
            {ts}Goal{/ts} <span class="goal-amount crmMoney">{$pcp.goal_amount|crmMoney:$pcp.currency}</span>
        </div>
        ...
        <div class="pcp-amount-raised">
             <span class="raised-amount crmMoney">{$total|crmMoney:$pcp.currency}</span> {ts}raised{/ts}
        </div>
    </div>
      {/if}
